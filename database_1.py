...
User_rating = pygame.image.load('Graph/rankrating/rating_canteen.jpg')
...
canteen1_map = pygame.image.load('Graph/Map/can1_map.png')
canteen2_map = pygame.image.load('Graph/Map/can2_map.png')
canteen9_map = pygame.image.load('Graph/Map/can9_map.png')
canteen11_map = pygame.image.load('Graph/Map/can11_map.png')
canteen16_map = pygame.image.load('Graph/Map/can16_map.png')

canteenT_map = pygame.image.load('Graph/Map/tam_map.png')
canteenN_map = pygame.image.load('Graph/Map/nhill_map.png')
canteen13_map = pygame.image.load('Graph/Map/can13_map.png')
canteenA_map = pygame.image.load('Graph/Map/nspine_map.png')
canteenB_map = pygame.image.load('Graph/Map/koufu_map.png')
...
canteen_map = {'canteen1':canteen1_map,
               'canteen2':canteen2_map,
               'canteen9':canteen9_map,
               'canteen11':canteen11_map,
               'canteen13':canteen13_map,
               'canteen16':canteen16_map,
               'canteenB': canteenB_map,
               'canteenA': canteenA_map,
               'canteenT':canteenT_map,
               'canteenN':canteenN_map}
